...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/fileopen.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/help.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionHelp.setIcon(icon2)
        self.actionSave = QAction(mainWindow)
        self.actionSave.setObjectName(u"actionSave")
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/filesave.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSave.setIcon(icon3)
        self.actionFront = QAction(mainWindow)
        self.actionFront.setObjectName(u"actionFront")
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/front.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionFront.setIcon(icon4)
        self.actionFront.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        self.actionBack = QAction(mainWindow)
        self.actionBack.setObjectName(u"actionBack")
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/back.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionBack.setIcon(icon5)
        self.actionBack.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        self.actionTop = QAction(mainWindow)
        self.actionTop.setObjectName(u"actionTop")
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons/top.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionTop.setIcon(icon6)
        self.actionTop.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        self.actionBottom = QAction(mainWindow)
        self.actionBottom.setObjectName(u"actionBottom")
        icon7 = QIcon()
        icon7.addFile(u":/icons/icons/bottom.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionBottom.setIcon(icon7)
        self.actionBottom.setMenuRole(QAction.MenuRole.NoRole)
        self.actionLeft = QAction(mainWindow)
        self.actionLeft.setObjectName(u"actionLeft")
        icon8 = QIcon()
        icon8.addFile(u":/icons/icons/left.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionLeft.setIcon(icon8)
        self.actionLeft.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        self.actionRight = QAction(mainWindow)
        self.actionRight.setObjectName(u"actionRight")
        icon9 = QIcon()
        icon9.addFile(u":/icons/icons/right.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionRight.setIcon(icon9)
        self.actionRight.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        self.actionIso = QAction(mainWindow)
        self.actionIso.setObjectName(u"actionIso")
        icon10 = QIcon()
        icon10.addFile(u":/icons/icons/iso.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionIso.setIcon(icon10)
        self.actionIso.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        ...
        self.actionFit.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        ...
        self.verticalLayout_2.addWidget(self.groupBoxGraph)
        ...
        self.mainToolBar.setOrientation(Qt.Orientation.Horizontal)
